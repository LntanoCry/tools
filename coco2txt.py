...
parser.add_argument('--json_path', default='/root/Projects/QueryDet-PyTorch/work_dirs/coco_querydet1/inference/coco_instances_results.json',type=str, help="input: coco format(json)")
